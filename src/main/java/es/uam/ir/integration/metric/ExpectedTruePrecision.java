 ...
 *
 */
public class ExpectedTruePrecision extends ExpectedMetric {
     ...
     * @param splitRatio 
     */
    public ExpectedTruePrecision(Recommender rec, ItemProbabilities probabilities, double splitRatio) {
    ...
    public double value() {
        ...
        for (int item = 0; item < probabilities.nItems; item++) {
            precision += ptrain * (probabilities.prel[probabilities.items[item]] - splitRatio * probabilities.prelrated[probabilities.items[item]]);
