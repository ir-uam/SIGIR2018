 ...
 *
 */
public class ObservedOptimalRecommender extends Recommender {
     ...
     * @param splitRatio 
     */
    public ObservedOptimalRecommender (double splitRatio) {
        this.splitRatio = splitRatio;
    }
    
    @Override
    public double f(int item, ItemProbabilities probabilities) {
        return probabilities.prelrated[item] / (1 - splitRatio * probabilities.prated[item]);
    }
}
